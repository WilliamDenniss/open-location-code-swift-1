...
class OpenLocationCodeAdditionalTests: XCTestCase {
  ...
  /// valid characters are still valid,  those with invalid characters are
  /// invalid.
  ...
  static var allTests = [
    ...
    ("testMaxDigitEncoding", testMaxDigitEncoding),
    ("testMaxDigitDecoding", testMaxDigitDecoding),
    ("testMaxDigitValidity", testMaxDigitValidity),
  ]
}
